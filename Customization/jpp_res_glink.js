...
function printFooterBlock()
{
	...
	write('<input id="Ok" name="Ok" type="button" class="button" value="Ok"	onClick="javascript:return jpp_res_ONCLICK1(this);"" hotKeyId="Go">');
	writeFooter();
	write('</div>');
	}
}//End function
...
function jpp_res_ONCLICK1(obj)
{
	var retVal = "";
	if (pre_ONCLICK('jpp_res',obj) == false) { 
		return false;
	}
	if ((retVal = fnLastButtonClick()) == false) {
		return false;
	}
	if (post_ONCLICK('jpp_res',obj) == false) { 
		return false;
	}
